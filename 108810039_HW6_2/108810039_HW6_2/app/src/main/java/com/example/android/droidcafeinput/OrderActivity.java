...
public class OrderActivity extends AppCompatActivity
    ...
    public void onClickCalendar(View view) {
        ...
        DatePickerDialog mDatePicker = new DatePickerDialog(OrderActivity.this, new DatePickerDialog.OnDateSetListener() {
            public void onDateSet(DatePicker datepicker, int selectedYear, int selectedMonth, int selectedDay) {
                // TODO Auto-generated method stub
                /*      Your code   to get date and time    */
                Log.e("Date Selected", "Month: " + selectedMonth + " Day: " + selectedDay + " Year: " + selectedYear);

                String message = "Date: " + selectedDay + "/" + selectedMonth + "/" + selectedYear;
                Toast toast = Toast.makeText(OrderActivity.this, message, Toast.LENGTH_SHORT);
                toast.show();
            }
        },year, month, day);

...
//    public void powNegativeIntergerFirstOperand() {
//        double resultPow = mCalculator.pow(-2d, 3d);
//        assertThat(resultPow, is(equalTo(-8d)));
//    }
//
...
//    public void powNegativeIntergerSecondOperand() {
//        double resultPow = mCalculator.pow(2d, -3d);
...
//    public void powZeroFirstOperandPositiveIntergerSecondOperand() {
...
//    public void powZeroFirstOperandMinusOneSecondOperand() {
...
//    }
    ...
    // (0, 2) -> 0
    public void testOne() {
        double resultPow = mCalculator.pow(0d, 02);
        assertThat(resultPow, is(equalTo(0d)));
    }
